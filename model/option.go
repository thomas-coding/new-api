...
func InitOptionMap() {
	...
	common.OptionMap["ShowInvitationCard"] = strconv.FormatBool(common.ShowInvitationCard)
	common.OptionMap["ShowTopupStore"] = strconv.FormatBool(common.ShowTopupStore)
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "ShowInvitationCard" || key == "ShowTopupStore" {
		...
		case "ShowInvitationCard":
			common.ShowInvitationCard = boolValue
		case "ShowTopupStore":
			common.ShowTopupStore = boolValue
