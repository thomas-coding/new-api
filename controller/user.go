...
func Register(c *gin.Context) {
	...
	if _, err := model.CreateDefaultTokenForUser(insertedUser.Id); err != nil {
...
func GetUserModels(c *gin.Context) {
	...
	groups := filterUserFacingUsableGroups(service.GetUserUsableGroups(user.Group), user.Group)
	var models []string
	...
	models = filterUserFacingModelNames(models)
	c.JSON(http.StatusOK, gin.H{
		"success": true,
		"message": "",
		"data":    models,
